...
while True:  # S_ID:jWxqT?]:4t;~#xxsXgjg
    if ultrasonic_28_7.get_distance() < 20:  # S_ID:N?=7w;-d]nQ_Ty:xdVxB
        ...
        # 直走  # S_ID:}y^I.ZIa3Z8PRL=r+D,3  # E_ID:}y^I.ZIa3Z8PRL=r+D,3
          # S_ID:6nb,i{r0*uW]_@dXLe^i
        if 'car' not in globals(): car = CarMotor()
        car.set_speed(50, 50)  # E_ID:6nb,i{r0*uW]_@dXLe^i  # E_ID:N?=7w;-d]nQ_Ty:xdVxB  # E_ID:jWxqT?]:4t;~#xxsXgjg  # E_ID:=NJ]emz+oNaL~f(Z,1Hj