...
(function() {
    ...
    window.CocoyaTheme.registerTheme({
        ...
        cssVars: {
            ...
            /* Dataset Manager tokens（Stage 5 切片 5：使用 dark 既有色彩）*/
            '--dsm-brand': '#FE2F89',
            '--dsm-brand-soft': 'rgba(254, 47, 137, 0.15)',
            '--dsm-brand-strong': 'rgba(254, 47, 137, 0.3)',
            '--dsm-text': '#e0e0e0',
            '--dsm-text-secondary': '#aaaaaa',
            '--dsm-text-muted': '#888888',
            '--dsm-border-light': '#404040',
            '--dsm-border-strong': '#555555',
            '--dsm-surface': '#252526',
            '--dsm-surface-alt': '#2d2d2d',
            '--dsm-input-bg': '#1e1e1e',
            '--dsm-btn-bg': '#3c3c3c',
            '--dsm-btn-hover-bg': '#4a2a35',
            '--dsm-code-bg': '#1e1e1e',
            '--dsm-message-bg': '#3a2b32',
            '--dsm-message-border': '#6b4455',
            '--dsm-message-text': '#ff8fb3',
