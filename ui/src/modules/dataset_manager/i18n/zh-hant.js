...
(function (Blockly) {
  ...
  Object.assign(Blockly.Msg, {
    ...
    "DSM_SPEC_WARN": "可用，尚有提醒",
    "DSM_VALIDATE_UNLABELED_SAMPLES": "已採集/匯入 %1 張照片，其中 %2 張尚未指定標籤。",
    "DSM_VALIDATE_OK_STATUS": "✅ 驗證通過：Spec 可用",
    "DSM_LABEL_DISK_RENAMED": "✅ 標籤改名完成，磁碟資料夾/檔名已同步（%1 個檔案）",
    "DSM_LABEL_DISK_RENAME_FAILED": "⚠️ 標籤已改名，但磁碟資料夾同步失敗: %1",
    "DSM_NAME_DRIFT_TIP": "⚠️ 磁碟既有資料仍在 dataset/%1/；改名不會搬移既有檔案（匯出與標籤改名將以新名稱 dataset/%2/ 為準，建議先匯出或改回原名）",
    "DSM_VALIDATE_FAIL_STATUS": "❌ 驗證發現 %1 個錯誤，請查看右欄訊息框",
    ...
    "DSM_SAMPLER_NO_LABEL": "請先於【標籤與樣本統計】面板新增標籤",
    ...
    "DSM_IMAGE_COUNT": "影像張數",
    "DSM_ANNOTATED_COUNT": "已標註",
    "DSM_BOX_COUNT": "標註框數",
    "DSM_LINE_COUNT": "標註線段",
    "DSM_COLOR": "顏色",
    ...
    "DSM_FEATURE_NO_LABEL": "請先於【標籤與樣本統計】面板新增並於右側選擇一個標籤",
