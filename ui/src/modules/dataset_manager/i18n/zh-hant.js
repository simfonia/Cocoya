...
(function (Blockly) {
  ...
  Object.assign(Blockly.Msg, {
    ...
    "DSM_PAGE_NEW_DATASET": "建立新資料集",
    "DSM_PAGE_MANAGE": "資料集管理",
    "DSM_PAGE_ANNOTATE": "標註",
    "DSM_EXIT_DM_CONFIRM": "確定退出 Dataset Manager？\n目前的資料已自動儲存於專案的 dataset/<資料集名稱> 資料夾，\n下次可用「選擇影像資料夾」匯入繼續。",
    "DSM_CLEAR_DATA": "清除資料",
    ...
    "DSM_CLASSIFY_SHORTCUTS_HINT": "↑/↓ 切換圖片 · Esc 回資料集管理",
    ...
    "DSM_SWITCH_TYPE_CONFIRM": "換類型將關閉目前資料集並回到類型入口，確定嗎？",
    "DSM_SWITCH_TYPE_HINT": "已回到類型入口，請選擇新類型另開新資料集",
    "DSM_TYPE_LOCKED_TIP": "類型已鎖定；換類型請回入口另開新資料集",
    "DSM_ENTRY_TITLE": "選擇資料集類型",
    "DSM_ENTRY_SUBTITLE": "選定後將鎖定類型；換類型請回此頁另開新資料集",
    "DSM_ENTRY_START": "開始",
    "DSM_ENTRY_DEV_BADGE": "開發中，功能未完善",
    "DSM_ENTRY_BACK": "重新選擇類型",
    "DSM_ENTRY_TYPE_IMAGE": "影像分類",
    "DSM_ENTRY_TYPE_OBJECT_DETECTION": "物件偵測",
    "DSM_ENTRY_TYPE_LINE_FOLLOWING": "循線",
    "DSM_ENTRY_TYPE_TABLE": "表格",
    "DSM_ENTRY_TYPE_FEATURE": "特徵",
    "DSM_ENTRY_TYPE_SERIAL": "序列",
    "DSM_ENTRY_DESC_IMAGE": "資料夾即類別，拍照或匯入後可校正標籤",
