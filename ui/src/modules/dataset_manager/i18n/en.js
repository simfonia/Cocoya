...
(function (Blockly) {
  ...
  Object.assign(Blockly.Msg, {
    ...
    "DSM_PAGE_NEW_DATASET": "Create New Dataset",
    "DSM_PAGE_MANAGE": "Dataset Management",
    "DSM_PAGE_ANNOTATE": "Annotation",
    "DSM_BACK_TO_MANAGE": "← Back to Dataset Management",
    "DSM_EXIT_DM_CONFIRM": "Exit Dataset Manager?\nData has been auto-saved under the project's dataset/<dataset name> folder.\nNext time, use \"Select Image Folder\" to import and continue.",
    ...
    "DSM_CLASSIFY_SHORTCUTS_HINT": "↑/↓ switch image · Esc back to Dataset Management",
    ...
    "DSM_SWITCH_TYPE_CONFIRM": "Switching type will close the current dataset and return to the entry. Continue?",
    "DSM_SWITCH_TYPE_HINT": "Back at the entry. Pick a new type to start another dataset.",
    "DSM_TYPE_LOCKED_TIP": "Type is locked. Go back to the entry to start another dataset.",
    "DSM_ENTRY_TITLE": "Choose a dataset type",
    "DSM_ENTRY_SUBTITLE": "The type is locked once selected. To switch, return here and start a new dataset.",
    "DSM_ENTRY_START": "Start",
    "DSM_ENTRY_DEV_BADGE": "In development, features incomplete",
    "DSM_ENTRY_BACK": "Reselect type",
    "DSM_ENTRY_TYPE_IMAGE": "Image Classification",
    "DSM_ENTRY_TYPE_OBJECT_DETECTION": "Object Detection",
    "DSM_ENTRY_TYPE_LINE_FOLLOWING": "Line Following",
    "DSM_ENTRY_TYPE_TABLE": "Table",
    "DSM_ENTRY_TYPE_FEATURE": "Feature",
    "DSM_ENTRY_TYPE_SERIAL": "Serial",
    "DSM_ENTRY_DESC_IMAGE": "Folders are classes; capture or import, then review labels",
