...
(function (Blockly) {
  ...
  Object.assign(Blockly.Msg, {
    ...
    "DSM_SPEC_WARN": "Valid, with reminders",
    "DSM_VALIDATE_UNLABELED_SAMPLES": "%1 photos captured/imported, %2 of them have no label yet.",
    "DSM_VALIDATE_OK_STATUS": "✅ Validation passed: Spec is valid",
    "DSM_LABEL_DISK_RENAMED": "✅ Label renamed; disk folders/filenames synced (%1 files)",
    "DSM_LABEL_DISK_RENAME_FAILED": "⚠️ Label renamed, but disk folder sync failed: %1",
    "DSM_NAME_DRIFT_TIP": "⚠️ Existing files remain in dataset/%1/; renaming does not move them on disk (export and label renaming will use the new name dataset/%2/). Consider exporting first or keeping the original name.",
    "DSM_VALIDATE_FAIL_STATUS": "❌ Validation found %1 error(s), see the panel on the right",
    "DSM_BACK_TO_MANAGE": "← Back to Dataset Management",
    ...
    "DSM_SAMPLER_NO_LABEL": "No labels yet — add one in the Labels & Sample Stats panel",
    ...
    "DSM_IMAGE_COUNT": "Images",
    "DSM_ANNOTATED_COUNT": "Annotated",
    "DSM_BOX_COUNT": "Boxes",
    "DSM_LINE_COUNT": "Lines",
    "DSM_COLOR": "Color",
    ...
    "DSM_FEATURE_NO_LABEL": "No labels yet — add one in the Labels & Sample Stats panel first",
