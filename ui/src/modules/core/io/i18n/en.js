(function (Blockly) {
  ...
  "IO_SERIAL_FLUSH": "ser.reset_input_buffer()",
  "IO_SERIAL_FLUSH_TOOLTIP": "Clear the serial input buffer, discarding all unread data. Useful to ensure the buffer is empty before reading new data.",
