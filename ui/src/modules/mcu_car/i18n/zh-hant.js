...
Blockly.Msg["CAR_SERVO"] = "設定 %1 %2 角度 %3 度";
...
// πCar Action System
Blockly.Msg["CAR_SERVO_SETUP"] = "設定 %1 型號 %2 脈衝 %3 ~ %4 角度 %5 度 微調 %6";
Blockly.Msg["CAR_SERVO_SETUP_TOOLTIP"] = "校準特定 servo 的訊號範圍與最大角度。微調：正值為順時針，負值為逆時針。";
Blockly.Msg["CAR_SERVO_TYPE_STANDARD"] = "SG90 (180°)";
Blockly.Msg["CAR_SERVO_TYPE_GEEK_270"] = "Geekservo (270°)";
Blockly.Msg["CAR_SERVO_TYPE_GEEK_270_180"] = "Geekservo (270° 縮限 180°)";
Blockly.Msg["CAR_SERVO_TYPE_CUSTOM"] = "自訂 (Custom)";
Blockly.Msg["CAR_HAND_RANGE"] = "設定 %1 雙手活動範圍 %2 度";
Blockly.Msg["CAR_HAND_RANGE_TOOLTIP"] = "設定雙手張開的最大角度。SG90 建議 180，Geek 270 建議 225。";
Blockly.Msg["CAR_IN_POSITION"] = "%1 雙手歸位 (張開)";
Blockly.Msg["CAR_IN_POSITION_TOOLTIP"] = "將雙手 servo 旋轉到初始位置。注意：此積木不等待動作完成。";
Blockly.Msg["CAR_MOVE_HANDS"] = "控制 %1 %2 旋出比例 %3 %% 速度 %4";
