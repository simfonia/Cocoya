...
## [已完成] 里程碑 v1.0 ~ v2.5 (核心架構、視覺 AI、資料處理、硬體通訊、運動分析)
- [x] UI 佈局、積木定位、硬體部署基礎。
...
- [x] **[New]** 上半身運動分析：出拳偵測、位移速度計算、座標邊界檢查。
- [x] **[New]** 系統穩定性加固：修復產生器遍歷崩潰與舊 ID 遷移。

## [待辦] 里程碑 v2.6: 效能優化與環境診斷
- [ ] **效能優化**：
    - [ ] 提升 `Overlay Image` 在高解析度下的運算效能 (NumPy 廣播優化)。
- [ ] **穩定性優化**：
